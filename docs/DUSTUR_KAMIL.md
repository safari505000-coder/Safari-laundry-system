...
### ✅ مكتمل (V19.3)
- [x] Stages A–G (الأساس، التصدير، AI/BI، HR، المخزون، UX، المراقبة).
- [x] Dark Mode كامل.
- [x] Card Taxonomy موحّد.
- [x] Purchase Order Workflow.
- [x] POS → Inventory auto-decrement.
- [x] Sentry + Health + Backup + Drift Guard.
- [x] القائمة الجانبية الهرمية الملوّنة.
