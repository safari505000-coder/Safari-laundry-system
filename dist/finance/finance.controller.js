...
let FinanceController = class FinanceController {
    ...
    getDriverMonitoring(user) {
        const scopedBranchId = user.role === client_1.SafariRole.MANAGER ? user.branchId : null;
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.SafariRole.OWNER, client_1.SafariRole.GENERAL_MANAGER, client_1.SafariRole.MANAGER, client_1.SafariRole.CALL_CENTER, client_1.SafariRole.CALL_CENTER_SUPERVISOR),
    (0, swagger_1.ApiOperation)({
        summary: `Driver monitoring map feed (${branding_1.APP_BRAND})`,
        description: 'V19.22.5 — Safari Pulse map feed of active ON_SHIFT drivers with lastKnownLocation markers. Scope:\n  - OWNER / GENERAL_MANAGER / CALL_CENTER / CALL_CENTER_SUPERVISOR: full fleet.\n  - MANAGER: branch-scoped (`driver.branchId == JwtUser.branchId`).\nBranch scoping is enforced at the API layer; UI route guards are advisory.',
    }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
...
__decorate([
    ...
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [unpaid_invoices_dto_1.UnpaidInvoicesQueryDto]),
    __metadata("design:returntype", Promise)
