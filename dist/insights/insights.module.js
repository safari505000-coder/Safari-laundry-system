...
exports.InsightsModule = InsightsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [insights_service_1.InsightsService, weekly_executive_report_service_1.WeeklyExecutiveReportService],
        exports: [insights_service_1.InsightsService, weekly_executive_report_service_1.WeeklyExecutiveReportService],
    })
], InsightsModule);
