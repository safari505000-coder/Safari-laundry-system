...
export declare class InvoiceAuditService {
    ...
    constructor(prisma: PrismaService, generalLedger: GeneralLedgerService, journal: DoubleEntryJournalService, customerNotifications: CustomerNotificationsService, jwt: JwtService);
