...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        description: 'Required. Declared settlement channel — one of CASH, KNET, PAYMENT_LINK, ONLINE, DEBT_ON_ACCOUNT.',
    }),
    (0, class_validator_1.IsNotEmpty)({ message: 'posPaymentMethod is required' }),
    (0, class_validator_1.IsIn)(QUICK_PAYMENT_METHODS, {
        message: 'posPaymentMethod must be CASH, KNET, PAYMENT_LINK, ONLINE, or DEBT_ON_ACCOUNT',
    }),
    __metadata("design:type", String)
], CreateOrderQuickDto.prototype, "posPaymentMethod", void 0);
