...
export declare const ROLE_PERMISSIONS: {
    OWNER: AppPermission[];
    GENERAL_MANAGER: (AppPermission.VIEW_INVOICES | AppPermission.SHARE_INVOICE | AppPermission.AUDIT_INVOICE | AppPermission.VIEW_REPORTS | AppPermission.VIEW_FINANCIAL_REPORTS | AppPermission.VIEW_CASH | AppPermission.VIEW_DEBTS | AppPermission.VIEW_CUSTOMERS | AppPermission.VIEW_INVENTORY | AppPermission.VIEW_PAYROLL | AppPermission.VIEW_AUDIT_LOGS | AppPermission.VIEW_EXPENSES | AppPermission.VIEW_DISPATCH | AppPermission.MANAGE_USERS)[];
    ...
    MANAGER: (AppPermission.VIEW_INVOICES | AppPermission.CREATE_INVOICE | AppPermission.UPDATE_INVOICE | AppPermission.SHARE_INVOICE | AppPermission.VIEW_REPORTS | AppPermission.VIEW_CASH | AppPermission.VIEW_DEBTS | AppPermission.VIEW_INVENTORY | AppPermission.CREATE_OPERATIONAL_DATA | AppPermission.UPDATE_OPERATIONAL_DATA | AppPermission.VIEW_EXPENSES | AppPermission.CREATE_EXPENSES | AppPermission.VIEW_DISPATCH | AppPermission.MANAGE_USERS)[];
    ...
    SUPERVISOR: (AppPermission.VIEW_INVOICES | AppPermission.UPDATE_INVOICE | AppPermission.SHARE_INVOICE | AppPermission.VIEW_REPORTS | AppPermission.VIEW_CUSTOMERS | AppPermission.UPDATE_OPERATIONAL_DATA | AppPermission.MANAGE_USERS)[];
