...
let UsersController = UsersController_1 = class UsersController {
    ...
    async assertCanViewStaffDirectory(user) {
    ...
    async assertCanMutateStaffDirectory(user) {
        (0, institutional_mutation_util_1.assertInstitutionalMutationAllowed)(user.role);
        if (user.role === client_1.SafariRole.OWNER) {
            return;
        }
        const ok = await this.permissionsService.canManageStaff(user.role);
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'OWNER only. Toggles `isActive` without touching role/branch/password.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'OWNER or MANAGER. Updates `basicMonthlySalary` + `monthlyAllowances`, and optionally `payrollRosterLineOrder`, `bankName`, `bankIban` for the payroll roster / salary transfer.',
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'OWNER only. GENERAL_MANAGER has read-only oversight; account enable/disable is OWNER-only.',
    }),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
    __param(2, (0, common_1.Req)()),
...
exports.UsersController = UsersController = UsersController_1 = __decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.SafariRole.OWNER, client_1.SafariRole.GENERAL_MANAGER, client_1.SafariRole.MANAGER, client_1.SafariRole.SUPERVISOR),
