 ...
 * operational debt (`getOperationalDebtKdBreakdown`; checked server-side).
 * This is NOT the canonical Customer 360 financial number; this DTO only
 * enforces the per-field regex.
 */
