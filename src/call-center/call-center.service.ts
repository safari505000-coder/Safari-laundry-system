...
import {
  ORDER_REMINDER_COOLDOWN_MS,
  SUBSCRIBER_REMINDER_COOLDOWN_MS,
  addKuwaitCalendarDays,
  assertCallCenterMaySendCollectionPaymentWa,
  buildReminderResult,
  classifyOrderWalletLedgerKind,
  extractDebtDiscount,
  extractDebtSettled,
  FOUR_DP,
  isDebtViaLinkRow,
  isManualCallCenterCollectionRow,
  isPartialDebtPaymentRow,
  KWD_DP,
  kuwaitDayBounds,
  kuwaitDayFromIso,
  ledgerBranchWhere,
  orderBranchWhere,
  parseKuwaitCalendarDateStart,
  readMetaString,
  readMetaStringArray,
  toKuwaitIsoDay,
} from './call-center.helpers';
...
export class CallCenterService {
  ...
  constructor(
    ...
    private readonly subscriptionRead: CallCenterSubscriptionReadService,
  ) {}
  ...
  listActiveSubscriptionPlans() {
    return this.subscriptionRead.listActiveSubscriptionPlans();
  }
  ...
  async searchCustomers(query: string) {
    return this.subscriptionRead.searchCustomers(query);
  }
  ...
  async listCustomerSettlementHistory(
    ...
    return this.subscriptionRead.listCustomerSettlementHistory(customerId, take);
  }
  ...
  async previewSubscriptionRollover(
    ...
    return this.subscriptionRead.previewSubscriptionRollover(customerId);
  }
  ...
  async listCustomerSubscriptionChain(
    ...
    return this.subscriptionRead.listCustomerSubscriptionChain(customerId);
  }
